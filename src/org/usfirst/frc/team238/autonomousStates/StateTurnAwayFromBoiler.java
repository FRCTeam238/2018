...
public class StateTurnAwayFromBoiler implements AutonomousState {

  CommandTurnAwayFromBoiler commandTurnAwayFromTheBoiler;
  ...
  public void prepare() {
    ...
    commandTurnAwayFromTheBoiler.setParams(parameters);
    commandTurnAwayFromTheBoiler.prepare();
  ...
  public void init(String[] params, CommandController theMcp) {
    // TODO Auto-generated method stub
    commandTurnAwayFromTheBoiler = (CommandTurnAwayFromBoiler) theMcp.getAutoCmd("CommandTurnAwayFromBoiler");
    parameters = params;
  ...
  public void process() {
    // TODO Auto-generated method stub
    Logger.Log("StateTurnAwayFromBoiler.Process() "+ count);
    count++;
    commandTurnAwayFromTheBoiler.execute();
  }

  @Override
  public boolean done() {

    if(commandTurnAwayFromTheBoiler.done()){
      count = 0;
      return true;
    }else{
      return false;
